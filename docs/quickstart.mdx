...
<Tabs>
<Tab title="Browser Use Cloud">
```bash add your key to .env file
BROWSER_USE_API_KEY=
```
Get your API key from [Browser Use Cloud](https://cloud.browser-use.com/dashboard/api).
</Tab>
<Tab title="Google">
```bash add your key to .env file
GOOGLE_API_KEY=
...
See [Supported Models](/customize/agent/supported-models) for more.
