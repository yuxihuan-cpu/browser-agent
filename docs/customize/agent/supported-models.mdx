...
- Balanced: fast + cheap + clever: `BU 1.0`

`BU 1.0` is our in-house model trained on millions of browser automation tasks, matching the accuracy of top models while completing tasks **3-5x** faster. [See our blog post→](https://browser-use.com/posts/speed-matters)

### Browser Use [example](https://github.com/browser-use/browser-use/blob/main/examples/models/browser_use_llm.py)

Fastest and smartest option, optimized specifically for browser automation.
