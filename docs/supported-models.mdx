...
`ChatBrowserUse()` is our in-house model trained on millions of browser automation tasks, matching the accuracy of top models while completing tasks **3-5x** faster. [See our blog post→](https://browser-use.com/posts/speed-matters)
